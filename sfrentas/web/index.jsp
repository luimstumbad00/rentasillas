...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="#"><i>Rensilla</i></a>
                        ...
                        <div class="form-group">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <div class="col-sm-12">
                                        <label><i class="fas fa-dollar-sign">${p.getPrecio()} MXN c/u</i></label>
                                    ...
                                    <div class=" col-sm-12 text-center">                                
                                        ...
                                        <a href="Controlador?accion=Comprar&id=${p.getId()}" class="btn btn-danger">Rentar ya!</a>
                                    </div>                         
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        <div class="form-group">
                                            <label>Nombres</label>
                                            <input type="text" name="txtnom" class="form-control" placeholder="Juan de dios Batiz">
                                        </div>
                                        <div class="form-group">
                                            <label>Dni</label>
                                            <input type="text" maxlength="8" name="txtdni" class="form-control" placeholder="2022090">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion</label>
                                            <input type="text" name="txtdire" class="form-control" placeholder="Zacatenco, Alcaldía Gustavo A. Madero, C.P. 07738">
                                        </div>
                                        <div class="form-group">
                                            <label>Email address</label>
                                            <input type="email" name="txtemail" class="form-control" placeholder="correoipn@ipn.com">
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
